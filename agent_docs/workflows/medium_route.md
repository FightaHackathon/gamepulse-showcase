...
After explicit workflow activation, use GPT-5.6 Sol as the orchestrator with medium reasoning. Before activation, preserve the current chat model. GPT-5.6 Luna is reserved for subagents.
